defmodule Ex4 do
  ...
  defp mult_acc(a, b, total), do: mult_acc(a, b - 1, total + a)

  @doc "Obtem o tamanho da lista l."
  def tamanho(l), do: tamanho_acc(l, 0)
  defp tamanho_acc([], a), do: a
  defp tamanho_acc([_ | r], a), do: tamanho_acc(r, a + 1)
  ...
  defp map_acc([h | r], f, total), do: map_acc(r, f, append(total, [f.(h)]))

  @doc "Calcula a soma dos numeros da lista l."
  def soma_lista(l), do: soma_lista_acc(l, 0)
  defp soma_lista_acc([], total), do: total
  defp soma_lista_acc([h | r], total), do: soma_lista_acc(r, total + h)
  ...
  defp concat_lista_acc([h | r], total), do: concat_lista_acc(r, total <> h)
  ...
  defp filter_acc([], _, total), do: total
  defp filter_acc([h | r], p, total), do: if p.(h), do: filter_acc(r, p, total ++ [h]), else: filter_acc(r, p, total)
